...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Ajuste das barras do sistema (Edge-to-Edge)
        ...
        val editNomeTrilha = findViewById<EditText>(R.id.editTextText2) // Corrigido para editTextText2
        val btnPlanejar = findViewById<Button>(R.id.button2)           // Corrigido para button2
